...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "I will be your Personal Life Companion. I can either assist you a Medical Diagnostic or " +
        "give you Counseling.      "    ;
    // If the user either does not reply to the welcome message or says something that is not
    // understood, they will be prompted again with this text.
    var repromptText = " To assist with health problems, say Start Diagnostic Test.  To assist with personal problems say Counselor.    ";
